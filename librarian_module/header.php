            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="images/abc.jpg" alt="..." class="img-circle profile_img">
                    </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="send_notification_student.php"><i class="fa fa-mail-forward"></i> SEND MSG TO STUDENT <span
                                        class="fa fa-chevron-down"></span></a>

                            </li>
                            </li>
                            <li><a href="reviews.php"><i class="fa fa-mail-forward"></i> USER FEEDBACK <span
                                        class="fa fa-chevron-down"></span></a>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                               aria-expanded="false">
                                <img src="images/abc.jpg" alt=""><?php echo $_SESSION["librarian"]; ?>
