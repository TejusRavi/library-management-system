                        ...
                        <form name="form1" action="" method="post">
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td>
                                        <input type="submit" name="submit1" value="search" class="form-control" style="background-color: orange; color: white">
                                    </td>
                                </tr>
                            </table>
                        </form>
                        ...
                        if(isset($_POST["submit1"]))
                        {
                            ...
                            while($row=mysqli_fetch_array($res)) {
                               echo "<tr>";
                                ...
                                echo "</td>";
                                echo "<td>";
                                ?> <a href="return.php?id=<?php echo $row["id"]; ?>">Return Books</a> <?php
